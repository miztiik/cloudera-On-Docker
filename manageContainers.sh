...
quickStartContainers["rotNode"]="docker run -dti --privileged=true --name rotNode2 -p 28920:2891 -p 28921:8085 -v /media/sf_dockerRepos/dockerTmp/utorrent:/opt/utorrent -v /media/sf_dockerRepos:/media/sf_dockerRepos alpine:latest /bin/sh"
